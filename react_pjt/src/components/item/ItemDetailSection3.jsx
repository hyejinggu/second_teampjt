...
const ItemDetailSection3 = () => {
    const [reviews, setReviews] = useState([
        { grade: 5, text: "만족합니다. 재질도 부들부들하니 저도 물고싶네요", date: "2022-08-21", recommendations: 7, user: "ehd****", },
        { grade: 4, text: "맘에 들어요", date: "2023-02-20", recommendations: 32, user: "rhk****", },
        { grade: 3, text: "보통이에요", date: "2021-08-19", recommendations: 1, user: "dkd****", },
        { grade: 2, text: "그냥 그래요", date: "2023-03-18", recommendations: 10, user: "rla****", },
        { grade: 1, text: "별로에요", date: "2023-03-20", recommendations: 0, user: "qkr****", },
        // 다른 리뷰 항목들도 마찬가지로 추가
    ]);
            ...
            <div className={styles.review_wrap}>
                ...
                <div className={styles.user_review}>
                    <ul className={styles.review_header}>
                        <li onClick={() => sortReviews("popular")} className={sortBy === "popular" ? styles.checking : null}>
                            인기순
                        </li>
                        <li onClick={() => sortReviews("latest")} className={sortBy === "latest" ? styles.checking : null}>
                            최신순
                        </li>
                        <li onClick={() => sortReviews("rating")} className={sortBy === "rating" ? styles.checking : null}>
                            별점순
                        </li>
                    </ul>
