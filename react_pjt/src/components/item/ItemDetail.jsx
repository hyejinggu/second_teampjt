    ...
    <div className="detail_wrap">
      <div className={styles.top_area}>
        ...
        <section className={styles.info_area}>
          {/* 상품명 */}
          <div>상품명</div>
          <div className={styles.present_pr}>{item.name}</div>
          {/* 판매가 */}
          <div>판매가</div>
          <div>
            <span className={styles.sale_info}>{item.saleInfo}%</span>
            <span className={styles.normal_pr}>{item.normalPr}원</span>
            <span className={styles.present_pr}>{item.normalPr}원</span>
          </div>
          {/* 배송비 */}
          <div>배송비</div>
        ...
        <div className={styles.purchase_info}>
          <div className={styles.purchase_left}>
            <div>
              ...
              출고됩니다.
              <br />
              2. 단, 재고가 없거나 주문정보의 누락, 배송지연이 별도 공지된
              제품은 제외될 수 있습니다.
              <br />
              3. 구매자의 부재, 주문정보 오류 등으로 인한 반송 시 왕복
              택배비(6,000원)는 고객 부담입니다.
              <br />
              4. 발송 후 택배의 송장번호를 문자로 보내드리며 한진택배
              웹사이트에서 조회하실 수 있습니다.
              <br />
          ...
          <div className={styles.purchase_right}>
            ...
            <div>
              ...
              <br />
              1. 반드시 반송 전 먼저 판매자와 연락하시어 반품사유, 택배사,
              배송비, 주소 등을 협의해 주세요.
              <br />
              2. 구매자의 단순변심 교환은 상품 수령 후 7일 이내이며,
              왕복배송비는 구매자 부담입니다.
              <br />
              3. 표시/광고와 상이, 상품 하자의 경우 상품 수령 후 3개월 이내
              교환이 가능합니다.
              <br />
              교환 및 반품이 불가능한 경우
              <br />
              ...
              <br />
              3. 상품을 개봉하였으나 포장이 훼손되어 상품가치가 현저히 상실된
              경우
              <br />
