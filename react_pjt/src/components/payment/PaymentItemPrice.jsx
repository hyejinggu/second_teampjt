        ...
        <div>
            ...
            <div className={styles.total_price}>
                ...
                <div className={styles.firstB_price}>
                    <span className={styles.product_price}>{totalPrice().toLocaleString()}원</span>
                    <span className={styles.delivery_price}>{delivery_price().toLocaleString()}원</span>
                    <span className={styles.total_price2}>{(totalPrice() + delivery_price()).toLocaleString()}원</span>
                </div>
